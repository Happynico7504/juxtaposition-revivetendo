...
// Same collection as miiverse-api's Conversation model (apps/miiverse-api/src/models/conversation.ts) —
// both services share one MongoDB database, and this schema is intentionally kept identical to it.
