	...
	return (
		...
		>
			<a href={url.url('/users/show', { pid: msg.pid })} className="scroll-focus mii-icon-container">
				<img src={url.cdn(msg.mii_face_url ? new URL(msg.mii_face_url).pathname : `/mii/${msg.pid}/normal_face.png`)} className="mii-icon" />
			</a>
				...
				{!isOwn
					? (
							<a
								...
								evt-click={`reportPost('${msg.id}','/friend_messages/${props.conversationId}')`}
							>
